...
import bbr.podcast.adapter.SearchResultsAdapter;
...
public class SearchResultsActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rvSearch.addItemDecoration(new SpacesItemDecoration(Utility.calculateNoOfColumns(this, 160), spacingInPixels, true));
    ...
    private void logSearchEvent(String searchQuery) {
        Bundle params = new Bundle();
        params.putString("search_query", searchQuery);
    ...
    public class FetchItunesPodcastTask extends AsyncTask<String, Void, List<ItunesPodcast>> {
        ...
        protected void onPostExecute(List<ItunesPodcast> result) {
            ...
            if (result != null) {
                ...
                Toast.makeText(SearchResultsActivity.this, R.string.error_downloading_data, Toast.LENGTH_SHORT);
            }
        }
    }
}