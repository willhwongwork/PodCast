...
public class MediaPlayerActivity extends AppCompatActivity {
    ...
    private void playFromUri() {
        ...
        if (getCallingActivity() != null) {
            ...
            if (getCallingActivity().getClassName().equals("bbr.podcast.PodcastEpsActivity")) {
    ...
    private void sendPlaylist() {
        ...
        if (getCallingActivity() != null) {
            Log.d(LOG_TAG, getCallingActivity().getClassName());
            if (getCallingActivity().getClassName().equals("bbr.podcast.PlaylistEpsActivity")) {
                subs = true;
